            ...
            <form className='experiences' onSubmit={submitExperience}>
                ...
                {experiences.map((experience) => {
                    return <div className='experience' key={experience.id}>
                        ...
                        <input className='title' type='text' defaultValue={experience.title} placeholder="position / title"/>
                        <input className='company' type='text'defaultValue={experience.company} placeholder="company name"/>
                        <textarea className='role' defaultValue={experience.role} placeholder="role"/>
                    </div>            
